...
hmDescription:"Date interval specifications are used to filter or query timestamped data based on given start date and end date.  Date interval specifications are based on date time offsets.",
